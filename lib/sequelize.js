...
module.exports = (function() {
  ...
  */
   ...
   * @oaran {Function}                optional callback to execute after successful definition of model
   * 
   * @return {Model}
   */
  Sequelize.prototype.define = function(modelName, attributes, options, callback) {
    options = options || {};
    var self = this

  ...
  **/
  ...
  QueryInterface.prototype.select = function(model, tableName, options, queryOptions) {
    ...
    queryOptions = Utils._.extend({}, queryOptions, {
      ...
      hasMultiValuedColumns: options.hasMultiValuedColumns,
  ...
  QueryInterface.prototype.rawSelect = function(tableName, options, attributeSelector, Model) {
    ...
    return this.sequelize.query(sql, null, queryOptions).then(function(data) {
      ...
      if (options && options.dataType) {
        ...
        } else if (dataType instanceof DataTypes.DATE || dataType instanceof DataTypes.TIME) {
  ...
  QueryInterface.prototype.isBaseTable = function(tableName, options) {
    var schema = null
      , schemaDelimiter = null;
    
    if (!this.QueryGenerator.hasOwnProperty("isBaseTableQuery")) {
    ...
    var sql = this.QueryGenerator.isBaseTableQuery(tableName, schema, schemaDelimiter);
  
    return this.sequelize.query(sql, { type: QueryTypes.BASETABLE }).then(function(data) {
      return Promise.resolve(data);
    });
  };
